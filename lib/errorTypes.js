 ...
 * Domain Error Types
 * ------------------
 * Custom error classes annotated with a stable `kind` + `statusCode` consumed
 * by the centralized error handler to produce consistent API error envelopes.
 * Keep these lean (no heavy logic) so they can be safely constructed anywhere.
 */
